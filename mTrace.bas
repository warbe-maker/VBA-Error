...
Option Explicit
' ---------------------------------------------------------------------------------
' Standard Module mTrace Procedure/code execution trace with display of the result.
'
' Uses: mErrHndlr
'       fMsg
'
...
Public Sub TrcBgnCd(ByVal s As String)
    TrcBgn s, DIR_BEGIN_CODE
End Sub

Public Sub TrcEndCd(ByVal s As String)
...
Public Sub TrcBgnPrc(ByVal s As String)
